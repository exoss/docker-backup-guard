...
# Bolt: Extract invariant EXCLUDED_PATHS list into a module-level frozenset constant.
# This eliminates the memory allocation overhead of creating the list on every function
# call and improves the membership check from O(N) array scanning to O(1) hash lookup.
