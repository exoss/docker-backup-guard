...
class BackupEngine:
    ...
    def perform_backup(self, container_id=None, progress_callback=None, lang="en"):
        ...
        try:
            ...
            # Performance optimization: Use os.scandir() with any() for O(1) empty directory check
            # instead of os.listdir() which loads the entire directory contents into memory.
