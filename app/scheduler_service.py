...
# Performance optimization: Use a shared Session object for heartbeat pings
# to enable TCP connection pooling and reuse TLS handshakes, reducing CPU and network overhead.
